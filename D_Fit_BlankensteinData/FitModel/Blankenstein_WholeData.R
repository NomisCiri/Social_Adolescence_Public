...
load("../GambleData.RData")
#bashInput<-c(1,5)
# Get actual Age and not only Agegroup.
AgeAndMore<-read.csv2("Rest.csv")# This is a df with nusiance. and all the other fun.
...
# If you want to fit the Model assuming one Hyperdistribution for ALL Subjects - You Ran the other script
# Bash Input will be 99 and you fit the model to every subject, not caring about age. Otherwise Data Will be subsetted here.
...
#setup the different modelfitting things.
  ...
  save(fitInfo,file="Blank_ModelFitsInfo_Model.RData")
  ...
  save(fitRisk,file="Blank_ModelFitsRisk_Model.RData")
  ...
  save(fitNoise,file="Blank_ModelFitsNoise_Model.RData")
  ###
  #################################
  ################################
  ################################
  ...
  save(fitNull,file="Blank_ModelFitsNull_Model.RData")
  ...
  save(fitSep,file="Blank_ModelFitsSep_Model.RData")
