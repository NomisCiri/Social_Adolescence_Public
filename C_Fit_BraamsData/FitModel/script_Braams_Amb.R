...
if(as.numeric(bashInput[2])==1){
  ...
  switch(as.character(bashInput[1]),
         "1"={
           save(fitInfo,file=paste0("../Model_Comparison/Kids_Braams_ModelFitsInfo_Model",bashInput[2],".RData"))
         },
         "2"={
           save(fitInfo,file=paste0("../Model_Comparison/EarlyAdol_Braams_ModelFitsInfo_Model",bashInput[2],".RData"))
         },
         "3"={
           save(fitInfo,file=paste0("../Model_Comparison/LateAdol_Braams_ModelFitsInfo_Model",bashInput[2],".RData"))
         },
         "4"={
           save(fitInfo,file=paste0("../Model_Comparison/YoungAdul_Braams_ModelFitsInfo_Model",bashInput[2],".RData"))
         }
  )#end AgeGroupswitch. 
  ...
  switch(as.character(bashInput[1]),
         "1"={
           save(fitRisk,file=paste0("../Model_Comparison/Kids_Braams_ModelFitsRisk_Model",bashInput[2],".RData"))
         },
         "2"={
           save(fitRisk,file=paste0("../Model_Comparison/EarlyAdol_Braams_ModelFitsRisk_Model",bashInput[2],".RData"))
         },
         "3"={
           save(fitRisk,file=paste0("../Model_Comparison/LateAdol_Braams_ModelFitsRisk_Model",bashInput[2],".RData"))
         },
         "4"={
           save(fitRisk,file=paste0("../Model_Comparison/YoungAdul_Braams_ModelFitsRisk_Model",bashInput[2],".RData"))
         }
  )#end AgeGroupswitch.
  ...
  switch(as.character(bashInput[1]),
         "1"={
           save(fitNoise,file=paste0("../Model_Comparison/Kids_Braams_ModelFitsNoise_Model",bashInput[2],".RData"))
         },
         "2"={
           save(fitNoise,file=paste0("../Model_Comparison/EarlyAdol_Braams_ModelFitsNoise_Model",bashInput[2],".RData"))
         },
         "3"={
           save(fitNoise,file=paste0("../Model_Comparison/LateAdol_Braams_ModelFitsNoise_Model",bashInput[2],".RData"))
         },
         "4"={
           save(fitNoise,file=paste0("../Model_Comparison/YoungAdul_Braams_ModelFitsNoise_Model",bashInput[2],".RData"))
         }
  )#end AgeGroupswitch.
  ...
  switch(as.character(bashInput[1]),
         "1"={
           save(fitNull,file=paste0("../Model_Comparison/Kids_Braams_ModelFitsNull_Model",bashInput[2],".RData"))
         },
         "2"={
           save(fitNull,file=paste0("../Model_Comparison/EarlyAdol_Braams_ModelFitsNull_Model",bashInput[2],".RData"))
         },
         "3"={
           save(fitNull,file=paste0("../Model_Comparison/LateAdol_Braams_ModelFitsNull_Model",bashInput[2],".RData"))
         },
         "4"={
           save(fitNull,file=paste0("../Model_Comparison/YoungAdul_Braams_ModelFitsNull_Model",bashInput[2],".RData"))
         }
  )#end AgeGroupswitch.
  ...
  switch(as.character(bashInput[1]),
         "1"={
           save(fitSep,file=paste0("../Model_Comparison/Kids_Braams_ModelFitsSep_Model",bashInput[2],".RData"))
         },
         "2"={
           save(fitSep,file=paste0("../Model_Comparison/EarlyAdol_Braams_ModelFitsSep_Model",bashInput[2],".RData"))
         },
         "3"={
           save(fitSep,file=paste0("../Model_Comparison/LateAdol_Braams_ModelFitsSep_Model",bashInput[2],".RData"))
         },
         "4"={
           save(fitSep,file=paste0("../Model_Comparison/YoungAdul_Braams_ModelFitsSep_Model",bashInput[2],".RData"))
         }
  )#end AgeGroupswitch.
}
